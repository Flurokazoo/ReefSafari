...
<section class="body-section">
    ...
    <div id="content-container" class="col-lg-12">
        ...
        <form action="" method="post" class="white-text">
            ...
            <input type="text" name="firstname" id="firstname" class="form-control border" value="<?= $user['firstName'] ?>"/>
            <br>
            <label for="lastname">Last Name: </label>
            <input type="text" name="lastname" id="lastname" class="form-control border" value="<?= $user['lastName'] ?>"/>
            <br>
            ...
            <input type="text" name="avatar" id="avatar" class="form-control border" value="<?= $user['avatar'] ?>"/>

            <input type="submit" name="update" class="updated btn btn-success border" value="Update"/>
        </form>
            </div>
    </div>
</section>
